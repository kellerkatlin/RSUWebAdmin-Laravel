<form id="miFormulario" action="{{ route('admin.voluntarios.store') }}" method="POST">
{{csrf_field()}}
    ...
    <div class="row mb-3">
        <div class="col-md-4 field-container">
            ...
            <select class="form-control"  id="tipo_doc" name="idtipodoc">
        ...
        <div class="col-md-4 field-container">
            <div id="campoAdicional" style="display: none;">
                <label id="campoAdicionalLabel" for="campoAdicionalInput" class="form-label"></label>
