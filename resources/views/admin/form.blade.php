...
@section('content')
    ...
    <head>
        ...
        <link href="{{ asset('vendos/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
        ...
        <div class="container body">
                                                ...
                                                <form class="form-horizontal form-label-left">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                            for="Nomnbre C">Nombre Completo <span
                                                                class="required">*</span>
                                                        </label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="middle-name"
                                                            class="col-form-label col-md-3 col-sm-3 label-align">Apellido</label>
                                                        <div class="col-md-6 col-sm-6 ">
                                                            <input id="middle-name" class="form-control col"
                                                                type="text" name="middle-name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label
                                                            class="col-form-label col-md-3 col-sm-3 label-align">Sexo</label>
                                                        <div class="col-md-6 col-sm-6 ">
                                                            <div id="gender" class="btn-group" data-toggle="buttons">
                                                                <label class="btn btn-secondary"
                                                                    ...
                                                                    <input type="radio" name="gender" value="male"
                                                                        class="join-btn"> &nbsp; Hombre &nbsp;
                                                                </label>
                                                                <label class="btn btn-primary"
                                                                    data-toggle-class="btn-primary"
                                                                    data-toggle-passive-class="btn-secondary">
                                                                    <input type="radio" name="gender" value="female"
                                                                        class="join-btn"> Mujer
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="item form-group">
                                                        <label class="col-form-label col-md-3 col-sm-3 label-align">Fecha
                                                            del Evento <span class="required">*</span>
                                                        </label>
                                                        <div class="col-md-6 col-sm-6 ">
                                                                ...
                                                                <div id="gender" class="btn-group"
                                                                    ...
                                                                    <label class="btn btn-secondary"
                                                                        ...
                                                                        <input type="radio" name="gender"
                                                                            value="male" class="join-btn"> &nbsp; Hombre
                                                                        &nbsp;
                                                                    </label>
                                                                    <label class="btn btn-primary"
                                                                        data-toggle-class="btn-primary"
                                                                        data-toggle-passive-class="btn-secondary">
                                                                        <input type="radio" name="gender"
                                                                            value="female" class="join-btn"> Mujer
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <footer>
                <div class="pull-right">
                    RSU - Admin Template by <a href="https://www.facebook.com/kellerkatlin.pinedotocas/">Keller Katlin</a>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
